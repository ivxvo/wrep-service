...
exports.get = async (input) => {
    ...
    for(let rep of input.reps) {
        ...
        await execRequest("report/export_result", { format: 8, outputFileName: rep.outputFileName })
            .then(() => {
...
//     let p = {
//         token: "02c887c9569595d393fb2b9b333c707c0EA7C971A3C307F2BA7EEBE8AB75CB9BEDF33CDD",
//         operateAs: "",
//         fl: 4
//     };
//     await execRequest("token/login", p);
// };
...
function login() {
    ...
    let params = {
        authz: {
            token: "02c887c9569595d393fb2b9b333c707c481885D24273E3CCF7C26E7C01CED00E179B1DBC",
        }
    };
